...
val logbackHttpAppenderVersion = "0.3.6-SNAPSHOT"
...
dependencies {
    ...
    runtimeOnly("com.github.e-switch-Solutions-AG:logback-http-appender:$logbackHttpAppenderVersion")
    ...
    testImplementation("com.ibm.mq:mq-java-testcontainer:2.0.4")
